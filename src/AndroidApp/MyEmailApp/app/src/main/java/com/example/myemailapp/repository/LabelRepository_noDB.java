...
//
//public class LabelRepository_noDB {
//    private static final String TAG = "LabelRepository";
//    private static LabelRepository_noDB instance;
...
//
//    private LabelRepository_noDB(Context context, String token) {
//        this.context = context.getApplicationContext();
//        this.token = token;
//        this.baseUrl = "http://10.0.2.2:8080/api"; // Adjust port as needed
//    }
//
//    public static synchronized LabelRepository_noDB getInstance(Context context, String token) {
//        if (instance == null) {
//            instance = new LabelRepository_noDB(context, token);
//        }
//        return instance;
//    }
//
